...
const StreamComp = () => {
  ...
  const streamHandler = async (e) => {
    ...
    try {
      e.preventDefault();
      let formattedFlowRate = streamDetails.flowRate * 10e18;
      ...
      const { hash } = await writeContract({
        ...
        abi: ABI,
        functionName: "createStream",
        args: [parseUnits(formattedFlowRate + "", 0), streamDetails.reciever],
      });
          ...
          >
            ...
            <div className="flex gap-10">
              <div className="flex flex-col">
                <label htmlFor="flow" className="mb-1 text-sm text-gray-200">
                  Flow Rate
                </label>
                <input
                  required
            ...
            <label htmlFor="company" className="mb-1 text-sm text-gray-200">
              Token
            </label>
            <input
